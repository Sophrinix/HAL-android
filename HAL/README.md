##The point of this repo is to get JSC built for android to link with HAL so that we can have HAL on Android.
I have all the dependencies in place. It's mostly a game of getting the cmake scripts correct now.

I have also annotated in cmake/TargetArch.cmake that we will need to support the additional CPU archs: armeabi armeabi-v7-a 
I am making the likely stupid assumption that x86 is the same be it windows or android. 

The main file that needs to be modified is  cmake/FindJavaScriptCore.cmake to make all of this work.
